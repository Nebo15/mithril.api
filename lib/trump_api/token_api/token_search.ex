defmodule Trump.TokenApi.TokenSearch do
  ...
  defp find_token(%{"id" => token_value} = params) do
    case Trump.Repo.get_by(Authable.Model.Token, value: token_value) do
      nil ->
  ...
  defp find_client({:ok, %{"client_id" => id, "client_secret" => secret} = params}) do
    case Trump.Repo.get_by(Authable.Model.Client, id: id, secret: secret) do
      nil ->
